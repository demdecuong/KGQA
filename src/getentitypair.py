...
from src.resolvedep import change_nouns
    ...
    def get_entity(self, text):
        ...
        for one_sentence in sentences:
            ...
            if normal_sent_:
                ...
                pairs = pd.DataFrame(ent_pairs, columns=['source', 'relation', 'target'])
...
if __name__ == '__main__':
    test = GetEntity()
    text = test.nlp("What is disease of Lymphedema, Accelerated atherosclerosis and TCC.")
